...
resolves them to the specific internal model name used by sub2gen.
...
# - 这里的 imageSize 是 sub2gen 的“放大档位”，并不等价于 OpenAI 的像素尺寸；
#   但可用作“画质/清晰度”的近似映射。
OPENAI_QUALITY_MAP = {
    "low": None,
    "standard": None,
...
# 用于把 OpenAI size（如 1024x1792）映射到最接近的 sub2gen aspect 选项
