...
ALTER TABLE generation_config RENAME COLUMN flow2api_market_backend TO sub2gen_market_backend;
ALTER TABLE generation_config RENAME COLUMN flow2api_market_provider_order TO sub2gen_market_provider_order;
ALTER TABLE generation_config RENAME COLUMN flow2api_market_enabled_providers TO sub2gen_market_enabled_providers;
ALTER TABLE generation_config RENAME COLUMN flow2api_market_provider_retry_count TO sub2gen_market_provider_retry_count;
ALTER TABLE generation_config RENAME COLUMN flow2api_market_model TO sub2gen_market_model;
ALTER TABLE generation_config RENAME COLUMN flow2api_market_enabled_models TO sub2gen_market_enabled_models;
ALTER TABLE generation_config RENAME COLUMN flow2api_market_primary_model TO sub2gen_market_primary_model;
ALTER TABLE generation_config RENAME COLUMN flow2api_market_fallback_models TO sub2gen_market_fallback_models;
...
VALUES ('project_identity', 'sub2gen', CURRENT_TIMESTAMP)
